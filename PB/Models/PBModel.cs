...
namespace PB.Models
{
    public class PBModel
    {
        ...
        public PBModel(double[,] x, int outPutCount = 10, int u1Count = 16 /*params int[] uCounts*/)
        {
        ...
        {
            U = PBMath.PBMath.MultiplyMatrices(V, X, null);
        }

        public void ComputeY()
        {
            Y = PBMath.PBMath.MultiplyMatrices(W, U, null);
        }
    }
}
